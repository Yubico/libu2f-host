...
json-c:
	...
	./configure --prefix=$(PWD)/tmp$(ARCH)/root CFLAGS=-mmacosx-version-min=10.6 LDFLAGS="-Xlinker -install_name -Xlinker @rpath/libjson-c.2.dylib" && \
	make install check && \
...
hidapi:
	...
	./bootstrap && \
	./configure --prefix=$(PWD)/tmp$(ARCH)/root CFLAGS=-mmacosx-version-min=10.6 LDFLAGS="-Xlinker -install_name -Xlinker @rpath/libhidapi.dylib" && \
	make install check && \
